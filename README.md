...
## Below this point you can find a list of potential tasks for coding interviews. You can find editorial solutions either on Leetcode or on following links: [Dropbox](https://vk.cc/7gmPHm) or [YouTube](https://vk.cc/7gmSJ5). I am not an author of the solutions from these links. My solutions are stored at this repo and fairly represent my coding skills for a moment.
